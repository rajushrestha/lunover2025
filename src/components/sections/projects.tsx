...
export default function Projects() {
  ...
  const translateX = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -(75 * (totalSlides - 1) + 75)] // 75vw for projects + 100vw for last section
  );
    ...
    <section ref={containerRef} className={cn("relative", `h-[300vh]`)}>
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        >
          ...
          <div className="h-full w-[100vw] text-center flex-shrink-0 flex flex-col items-center justify-center relative p-8 sm:p-16 bg-foreground text-background dark:bg-background dark:text-foreground">
